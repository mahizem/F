...
$sql = "select charge from hospital where id = '$id'";
$res = mysqli_query(  $conn , $sql);
...
$sql = "select balance from hospitalbalance where ano = '100023'";
$res = mysqli_query(  $conn , $sql);
$hospital_balance = mysqli_fetch_array($res, MYSQLI_NUM);
$add = $hospital_balance[0] + $charge_amount[0];
$sql = "UPDATE hospitalbalance  SET balance = '$add' WHERE ano = '100023' ";
$retval = mysqli_query(  $conn , $sql);
